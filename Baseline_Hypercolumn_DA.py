...
path_to_model = 'cnn_states/HypercolumnBaseline_DA' # path to save model (DA = Data Augmentation)
os.makedirs(path_to_model, exist_ok=True)

path_to_plot = 'Plots/HypercolumnBaseline_DA' # path to save plots (DA = Data Augmentation)
