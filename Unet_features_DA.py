...
lib.ReshapeDataLoader(DataLoader(GreenlandData(split='train', transforms=True),
                                        batch_size=batch_size,
                                        shuffle='True',
                                        num_workers=1))

dl_train = lib.ReshapeDataLoader(DataLoader(GreenlandData(split='train', transforms=True), batch_size=batch_size, shuffle='True', num_workers=1))
...
dl_train_single = lib.ReshapeDataLoader(DataLoader(GreenlandData(split='train', transforms=True), batch_size=1, shuffle='False', num_workers=1))
